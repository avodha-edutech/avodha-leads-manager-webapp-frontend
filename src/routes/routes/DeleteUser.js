...
const DeleteUser = () => {
    ...
    const handleSubmit = () => {
        ...
        if((email)&&email != null && (mode)&&mode != null && (language)&&language != null)
        {
            ...
            if(isValidEmail((email)&&email) != null)
            {
                ...
                var apiUri = "https://apileads.avodha.net/api/v1/deleteuser/" + emailValue + "/" + languageValue + "/" + modeValue;
    ...
    const buttonData = (<>
        <div className="d-flex justify-content-center align-items-center mt-3 p-4">
            <button className="main-button" onClick={handleSubmit}>Delete</button>
        </div>
    </>);
    ...
    const formatError = (
        <div className="d-flex justify-content-center align-items-center mt-4">
            <Alert severity="error" className="mt-3">Invalid input format</Alert>
        </div>
    );
    ...
    const successMessage = (
        <div className="d-flex justify-content-center align-items-center mt-4">
            <Alert severity="success" className="mt-3">User successfully deleted from database</Alert>
        </div>
    );
        ...
        <div className="main-div-dashboard">
            <div className="sub-main-div">
                <div className="data-div">
                    <h3 className="mt-3 text-center">Delete User</h3>
                    <div className="d-flex justify-content-center align-items-center mt-4">
                        <label>
                            Email
    ...
    const returnData = (<>
        <Dashboard selected={5}>{mainData}</Dashboard>
    </>);
