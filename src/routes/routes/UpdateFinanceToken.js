...
const UpdateFinanceToken = () => {
    ...
    axios.get('https://apileads.avodha.net/api/v1/getfinancetoken').then((data) => {
    ...
    const handleUpdate = () => {
        ...
        if((newTokenValue)&&newTokenValue != null)
        {
            ...
            axios.put('https://apileads.avodha.net/api/v1/updatefinancetoken',(toPutData)).then((data) => {
    ...
    const successMessage = (
        <div className="d-flex justify-content-center align-items-center mt-4">
            <Alert severity="success" className="mt-3">Finance Token successfully updated</Alert>
        </div>
    );
        ...
        <div className="main-div-dashboard">
            <div className="sub-main-div">
                <div className="data-div">
                    <h3 className="text-center mt-3">Update Finance Token</h3>
    ...
    const returnData = (<>
        <Dashboard selected={8}>{(mainState)&&mainState ? mainLoading : mainData}</Dashboard>
    </>);
...
export default UpdateFinanceToken;